...
#                 if franq in range(1,32):

# # para o Ano de 2023 vai parar de funcionar?
# # tudo essa parte inferir creio que para para substituir por umas duas linhas, só pegar o caminho certo e mover para a pasta.
# # antes de mover, verificar se a pasta de destino existe... pois se nao existir vai dar erro e vai perder o arquivo!
